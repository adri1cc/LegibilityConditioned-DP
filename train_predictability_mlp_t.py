# Train predictibility MLP, with a pre-trained Diffusion Policy model and a pre-trained scene encoder
...
for i in range(1, 7):
    ...
    dataset_path = [f"data/t_40_optim_trajectories_{i}.hdf5"]
    ...
    torch.save(film_generator.state_dict(), f"output/mlp/t_predictability_{num_epochs}e_{i}.pt")
